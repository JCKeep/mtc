    ...
    <el-container>
      ...
      <el-container>
        ...
        <el-main class="main-box">
          ...
          <div style="border-radius: 15px; padding: 35px;box-shadow: 15px 15px 15px #d3d3d3;">
            ...
            <el-button @click="FoodHome()" auto-insert-space class="record-cancel">返回</el-button>
          </div>
        </el-main>
      </el-container>
    </el-container>
